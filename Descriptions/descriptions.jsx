...
const types = {
    ...
    properties: [
        ...
        },
        {
            ...
            valueType: 'string',
            editorType: 'TextArea',
            defaultValue: '[{"label":"Name","value":"Socrates"},{"label":"Mobile","value":"123-1234-1234"},{"label":"Residence","value":"Beijing"},{"label":"Hometown","value":"Beijing"},{"label":"Address","value":"Yingdu Building, Zhichun Road, Beijing"}]'
        },
        {
            key: 'column',
            label: '列数',
...
class Widget extends VisibleWidget {
    constructor(props) {
        ...
        this.colon = props.colon;
        this.dataStr = props.data;
    }
    ...
    render() {
        ...
        try {
            ...
            this.widgetWarn('Invalid JSON data: ' + e.message);
            data = [];
        }

        return (
            <div style={{ width: this.__width, height: this.__height, overflow: 'auto' }}>
                <Descriptions
