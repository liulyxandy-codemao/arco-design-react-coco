...
class Widget extends VisibleWidget {
    constructor(props) {
        ...
        this.panelTodayBtn = props.panelTodayBtn;
        this.mode = props.mode;
        this.dayStartOfWeek = props.dayStartOfWeek;
        ...
        return (
            <div style={{ width: this.__width, height: this.__height, overflow: 'auto' }}>
                <Calendar
                    ...
                    panel={true}
                    panelTodayBtn={this.panelTodayBtn}
                    mode={this.mode}
                    dayStartOfWeek={this.dayStartOfWeek}
                    onChange={(date) => {
                        this.emit('onChange', date.format('YYYY-MM-DD'));
                    }}
                    style={{ width: '100%' }}
                />
            </div>
